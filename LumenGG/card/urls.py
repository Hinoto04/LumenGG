...
urlpatterns = [
    ...
    path('effect-review/guide/', views.effectDslGuide, name='effectDslGuide'),
    path('effect-review/reference/', views.effectDslReference, name='effectDslReference'),
    path('effect-review/<int:id>/', views.effectReview, name='effectReview'),
    path('effect-review/<int:id>/sandbox/start/', views.effectSandboxStart, name='effectSandboxStart'),
    path('effect-review/<int:id>/sandbox/decision/', views.effectSandboxDecision, name='effectSandboxDecision'),
