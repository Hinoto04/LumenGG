...
urlpatterns = [
    ...
    path('v2/create/mobile', views.createMobileV2, name='createMobileV2'),
    path('v2/update/<int:id>', views.updateV2, name='updateV2'),
    path('v2/update/<int:id>/mobile', views.updateMobileV2, name='updateMobileV2'),
    ...
    path('create/mobile', views.createMobileV2, name='createMobile'),
    path('createSearch', views.createSearch, name='createSearch'),
    path('update/<int:id>', views.updateV2, name='update'),
    path('update/<int:id>/mobile', views.updateMobileV2, name='updateMobile'),
