...
def apply_tao_latched_harmony(apps, schema_editor):
    set_tao_options(apps, NEW_TAO_OPTIONS)


def restore_tao_harmony_at_least(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('battlelog', '0007_battleevent_uid_buffer'),
    ]

    operations = [
        migrations.RunPython(apply_tao_latched_harmony, restore_tao_harmony_at_least),
    ]
